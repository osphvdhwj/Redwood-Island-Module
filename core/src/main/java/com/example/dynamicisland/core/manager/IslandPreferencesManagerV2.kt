...
object IslandPreferencesManagerV2 {
    ...
    private fun buildThemeFromClient(client: IslandIPCClient): IslandTheme {
        return IslandTheme(
            ...
            chargingStyle    = com.example.dynamicisland.shared.settings.ChargingStyle.valueOf(client.getString("charging_style", "RING") ?: "RING"),
            callStyle        = com.example.dynamicisland.shared.settings.CallStyle.valueOf(client.getString("call_style", "IOS") ?: "IOS"),
            batteryStyle     = com.example.dynamicisland.shared.settings.BatteryStyle.valueOf(client.getString("battery_style", "PILL") ?: "PILL"),
