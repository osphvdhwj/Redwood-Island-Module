...
class SettingsManager(private val context: Context) {
    ...
    enum class SettingKey {
        ...
        AMBIENT_REACTIVE, ANIMATION_SPEED, PHYSICS_STYLE, CONTENT_TRANSITION_STYLE,
        ...
        ALLOW_MUSIC_MID, ALLOW_MUSIC_MAX, ALLOW_CHARGING_MINI, ALLOW_CHARGING_MID,
        ...
        SHOW_RING_IDLE, PILL_SHAPE, PILL_RADIUS,
        ...
        HAPTIC_FEEDBACK, HAPTIC_INTENSITY, RING_CADENCE_VIBRATION, HAPTIC_MORSE_ALERTS,
        ROLE_CALLING_APP, ALLOWED_MUSIC_APPS, ALLOWED_MEDIA_APPS, ALLOWED_NOTES_APPS,
