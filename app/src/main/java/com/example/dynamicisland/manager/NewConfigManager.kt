...
object NewConfigManager {
    ...
    private fun buildThemePayload(prefs: SharedPreferences): Map<String, Any> {
        return mapOf(
            ...
            "charging_style" to (prefs.getString("charging_style", "RING") ?: "RING"),
            "call_style" to (prefs.getString("call_style", "IOS") ?: "IOS"),
            "battery_style" to (prefs.getString("battery_style", "PILL") ?: "PILL"),
