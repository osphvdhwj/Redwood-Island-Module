...
fun PillRouter(
    ...
    onIntent: (com.example.dynamicisland.ui.mvi.IslandIntent) -> Unit
) {
...
@Composable
fun MiniPillRouter(model: LiveActivityModel, onIntent: (com.example.dynamicisland.ui.mvi.IslandIntent) -> Unit) {
...
@Composable
fun MidPillRouter(model: LiveActivityModel, onIntent: (com.example.dynamicisland.ui.mvi.IslandIntent) -> Unit) {
    when (model) {
...
@Composable
fun MaxPillRouter(model: LiveActivityModel, onIntent: (com.example.dynamicisland.ui.mvi.IslandIntent) -> Unit) {
